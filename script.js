const translations = {
  en: {
    ...
    note1Title: "Formal or smart casual",
    note1Body:
    ...
    note2Label: "Arrival",
    note2Title: "From 9:45 AM",
    note2Body:
      "Guests are invited to arrive from 9:45 AM. The ceremony begins at 10:30 AM on the Front Lawn.",
  ...
  zh: {
    ...
    note1Label: "服裝",
    note1Title: "Formal 或 Smart casual",
    note1Body: "歡迎 Formal 或 Smart casual 打扮。柔和色調適合海傍場地；男士請避免拖鞋及無袖上衣。",
    note2Label: "到達時間",
    note2Title: "上午9時45分起",
    note2Body: "誠邀賓客於上午9時45分起到達，儀式將於上午10時30分在 Front Lawn 開始。",
    note3Label: "交通",
    note3Title: "接駁巴士",
